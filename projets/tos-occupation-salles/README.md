# Projet : Extraction Taux d'Occupation des Salles (TOS)
...
- [Contrôle qualité croisé ADE ↔ ABYLA](../../etl-integration-patterns/import-csv-oracle/controle-qualite-croise.md) — détection des salles planifiées sans correspondance patrimoine
- [Pattern import CSV](../../etl-integration-patterns/import-csv-oracle/pattern-import-csv.md) — import et évolution du référentiel des salles
